...
2. 빈칸 문제입니다.
- Redux에서 createStore 함수는 첫 번째 인자로 _______ 함수를 받는다.
- _______ 함수는 Redux의 state와 dispatch를 React 컴포넌트의 props로 연결하기 위해 mapStateToProps와 mapDispatchToProps를 인자로 받습니다.
